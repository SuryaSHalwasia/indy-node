import json
from perf_req_gen_seq import RGSeqReqs
from perf_req_gen_nym import RGNym, RGGetNym
from perf_req_gen_schema import RGSchema, RGGetSchema
from perf_req_gen_attrib import RGAttrib, RGGetAttrib
from perf_req_gen_definition import RGGetDefinition, RGDefinition
from perf_req_gen_revoc import RGDefRevoc, RGGetDefRevoc, RGEntryRevoc, RGGetEntryRevoc, RGGetRevocRegDelta
from perf_req_gen_payment import RGGetPaymentSources, RGPayment, RGVerifyPayment
from perf_req_gen_cfg_writes import RGConfigChangeState
from perf_req_gen_demoted_node import RGPoolNewDemotedNode
from perf_req_gen_get_txn import RGGetTxn
from perf_req_gen_get_taa import RGGetTAA
from perf_req_gen_get_taa_aml import RGGetTAAAML
from perf_req_gen_get_auth_rules import RGGetAuthRules
from perf_req_gen_fees import RGGetFees
from perf_req_gen_demote import RGDemoteNode
from perf_req_gen_promote import RGPromoteNode
...
class ReqTypeParser:
    _supported_requests = \
        {"nym": RGNym, "schema": RGSchema, "attrib": RGAttrib, "cred_def": RGDefinition, "revoc_reg_def": RGDefRevoc,
         ...
         "get_fees": RGGetFees, "demote": RGDemoteNode, "promote": RGPromoteNode}
