...
# Append the script directory to the module names
perf_load_path = os.path.join(current_script_dir, 'perf_load')
sys.path.append(perf_load_path)

from perf_client_msgs import ClientReady, ClientStop, ClientSend
from perf_utils import check_fs, check_seed, logger_init, random_string
from perf_gen_req_parser import ReqTypeParser
from perf_client import LoadClient
from perf_client_runner import ClientRunner
from perf_client_fees import LoadClientFees
from perf_utils import PoolRegistry
...
class LoadRunner:
    ...
    def load_run(self):
        print("Version                  ", __version__, file=self._out_file)
        ...
        self._logger.info("load_run version {} params {}".format(__version__, self.__dict__))
